    ...
    return (
        <div className="navigation">
            ...
            <div className="navigationContainer">
                ...
                <div className="navBox" onClick={() => handleSelectPage(numbersPages[0])}>
                    {numbersPages[0]}
                    </div>
                <div className="navBox" onClick={() => handleSelectPage(numbersPages[1])}>
                    {numbersPages[1]}
                    </div>
                <div className="navBox" onClick={() => handleSelectPage(numbersPages[2])}>
                    {numbersPages[2]}
                    </div>
